...
| **쪽수 검증** | 변환할 때마다 원본 HWP의 쪽수와 만들어진 PDF의 실제 쪽수를 대조합니다. 다르면 `확인필요`로 표시합니다. |
...
한글 자동화의 `SaveAs ... "PDF"` 는 **한글에 남아 있는 마지막 인쇄 범위 설정을 물려받아
문서 일부만 저장될 수 있습니다.** 조용히 일어나기 때문에 나중에 발견하기 어렵습니다.
이 도구는 매번 쪽수를 대조해 그런 경우를 잡아냅니다.
